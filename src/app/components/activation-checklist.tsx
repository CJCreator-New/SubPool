...
import { useMemberships, useNotifications } from '../../lib/supabase/hooks';

type ChecklistStepId = 'profile_completed' | 'first_join_request' | 'notification_interaction';
...
export function ActivationChecklist() {
  ...
  }), [memberships, notifications, profile?.bio, profile?.display_name]);

...
DROP POLICY IF EXISTS "marketing_waitlist_admin_select" ON marketing_waitlist;
DROP POLICY IF EXISTS "marketing_waitlist_admin_select" ON marketing_waitlist;
DROP POLICY IF EXISTS "marketing_waitlist_admin_select" ON marketing_waitlist;
...
DROP POLICY IF EXISTS "marketing_waitlist_public_insert" ON marketing_waitlist;
DROP POLICY IF EXISTS "marketing_waitlist_public_insert" ON marketing_waitlist;
DROP POLICY IF EXISTS "marketing_waitlist_public_insert" ON marketing_waitlist;
